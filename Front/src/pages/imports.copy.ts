const ru = {
  ...
  changesTitle: 'Сравнение с текущими данными',
  changesNote: 'Результат сравнения на момент обработки пакета. При применении сервер проверяет данные повторно.',
  newRecords: 'Новые',
  updatedRecords: 'Изменённые',
  unchangedRecords: 'Без изменений',
  sampleIds: 'Примеры ID — до 50 в каждой категории',
  warningsTitle: 'Обратите внимание',
  noGoalWarning: 'У части сотрудников не указана карьерная цель. Где возможно, следующий грейд определяется по текущему профилю.',
...
const en: Copy = {
  ...
  changesTitle: 'Comparison with current data', changesNote: 'The comparison at the time the package was processed. The server validates data again when applying it.', newRecords: 'New', updatedRecords: 'Updated', unchangedRecords: 'Unchanged', sampleIds: 'Sample IDs — up to 50 per category', warningsTitle: 'Please note', noGoalWarning: 'Some employees have no explicit career goal. Where possible, the next grade is inferred from their current profile.',
...
const kk: Copy = {
  ...
  changesTitle: 'Қазіргі деректермен салыстыру', changesNote: 'Жинақты өңдеу кезіндегі салыстыру нәтижесі. Қолдану кезінде сервер деректерді қайта тексереді.', newRecords: 'Жаңа', updatedRecords: 'Өзгертілген', unchangedRecords: 'Өзгеріссіз', sampleIds: 'ID мысалдары — әр санатта 50-ге дейін', warningsTitle: 'Назар аударыңыз', noGoalWarning: 'Кейбір қызметкерлердің мансаптық мақсаты көрсетілмеген. Мүмкін болғанда келесі деңгей қазіргі профиль бойынша анықталады.',
