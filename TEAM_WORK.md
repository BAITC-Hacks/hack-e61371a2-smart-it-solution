...
| --- | --- | --- | --- |
| Backend и интеграция | Капитан и Codex в текущей задаче | `Back/**`, корневой Compose, `.github/**`, общие документы | PostgreSQL, миграции, импорт, сессии, права, контракт API, Docker, интеграционные проверки |
